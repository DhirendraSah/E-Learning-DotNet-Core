...
namespace E_Learning.Migrations
{
    ...
    [Migration("20250217184319_DashboardData")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("E_Learning.Models.EducatorDashboardViewModel", b =>
                {
                    b.Property<int>("TotalEnrollments")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("TotalEnrollments"));
            ...
            modelBuilder.Entity("E_Learning.Models.Enrollment", b =>
                {
                    ...
                    b.Property<int?>("EducatorDashboardViewModelTotalEnrollments")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("EducatorDashboardViewModelTotalEnrollments");

                    b.ToTable("Enrollments");
                });

            modelBuilder.Entity("E_Learning.Models.EnrollmentViewModel", b =>
                {
                    b.Property<string>("StudentEmail")
            ...
            modelBuilder.Entity("E_Learning.Models.Enrollment", b =>
                {
                    ...
                    b.HasOne("E_Learning.Models.EducatorDashboardViewModel", null)
                        .WithMany("RecentEnrollments")
                        .HasForeignKey("EducatorDashboardViewModelTotalEnrollments");
            ...
            modelBuilder.Entity("E_Learning.Models.EducatorDashboardViewModel", b =>
                {
                    b.Navigation("RecentEnrollments");
                });
